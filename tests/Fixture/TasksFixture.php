...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cp' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-05-09 09:11:51',
                'modified' => '2021-05-09 09:11:51',
            ],
        ];
        parent::init();
    }
